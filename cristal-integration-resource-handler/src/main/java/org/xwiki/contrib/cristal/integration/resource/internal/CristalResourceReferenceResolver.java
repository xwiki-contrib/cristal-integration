...
/**
 * Resolver for a Cristal resource.
 *
 * @version $Id$
 * @since 1.1.0
 */
...
@Named("cristal")
@Singleton
public class CristalResourceReferenceResolver extends AbstractResourceReferenceResolver
{
    @Override
    public ResourceReference resolve(ExtendedURL extendedURL, ResourceType resourceType,
        Map<String, Object> parameters)
    {
        return new CristalResourceReference();
    }
}
